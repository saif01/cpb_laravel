...
class CommunityController extends Controller
{
    ...
    public function Add()
    {
        return view('admin.csr.community.add');
    }

    //All
    public function All()
    {
        $allData = Community::orderBy('id', 'desc')->get();
        return view('admin.csr.community.all')->with('allData', $allData);
    }
    ...
    public function Insert(Request $request)
    {
        ...
        if (!empty($image)) {
            ...
            $upload_path = 'public/images/community/';
        ...
        if (!empty($document)) {
            ...
            $doc_upload_path = 'public/images/community/';
        ...
        if ($successData) {
            ...
            return Redirect()->route('community.all')->with($notification);
        } else {
            $notification = array(
    ...
    public function editFormShow($id)
    {
        ...
        // print_r($data);
        return view('admin.csr.community.edit')->with('data', $data);
    }
