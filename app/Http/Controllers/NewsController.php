...
class NewsController extends Controller
{
    ...
    public function Add()
    {
        return view('admin.csr.news.add');
    }

    //All
    public function All()
    {
        $allData = News::orderBy('id', 'desc')->get();
        return view('admin.csr.news.all')->with('allData', $allData);
    }
    ...
    public function Insert(Request $request)
    {
        ...
        if (!empty($document)) {
            ...
            $doc_upload_path = 'public/images/news/';
    ...
    public function editFormShow($id)
    {
        ...
        // print_r($data);
        return view('admin.csr.news.edit')->with('data', $data);
    }
