...
class PressController extends Controller
{
    ...
    public function Add()
    {
        return view('admin.news.press.add');
    }

    //All
    public function All()
    {
        $allData = Press::orderBy('id', 'desc')->get();
        return view('admin.news.press.all')->with('allData', $allData);
    }
    ...
    public function Insert(Request $request)
    {
        ...
        if (!empty($image)) {
            ...
            $upload_path = 'public/images/press/';
        ...
        if (!empty($document)) {
            ...
            $doc_upload_path = 'public/images/press/';
        ...
        if ($successData) {
            ...
            return Redirect()->route('press.all')->with($notification);
        } else {
            $notification = array(
    ...
    public function editFormShow($id)
    {
        ...
        // print_r($data);
        return view('admin.news.press.edit')->with('data', $data);
    }
