...
class SRController extends Controller
{
    ...
    public function Add()
    {
        return view('admin.csr.sr.add');
    }

    //All
    public function All()
    {
        $allData = SR::orderBy('id', 'desc')->get();
        return view('admin.csr.sr.all')->with('allData', $allData);
    }
    ...
    public function Insert(Request $request)
    {
        ...
        if (!empty($document)) {
            ...
            $doc_upload_path = 'public/images/sr/';
    ...
    public function editFormShow($id)
    {
        ...
        // print_r($data);
        return view('admin.csr.sr.edit')->with('data', $data);
    }
