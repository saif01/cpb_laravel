...
use App\Trdev;
class TrDevController extends Controller
{
    //add
    public function Add()
    {
        return view('admin.news.trdev.add');
    }

    //All
    public function All()
    {
        $allData = Trdev::orderBy('id', 'desc')->get();
        return view('admin.news.trdev.all')->with('allData', $allData);
    }
    ...
    public function Insert(Request $request)
    {
        ...
        if (!empty($image)) {
            ...
            $upload_path = 'public/images/trdev/';
        ...
        if (!empty($document)) {
            ...
            $doc_upload_path = 'public/images/trdev/';
        ...
        if ($successData) {
            ...
            return Redirect()->route('trdev.all')->with($notification);
        } else {
            $notification = array(
    ...
    {
        $data = Trdev::findOrFail($id);
        // print_r($data);
        return view('admin.news.trdev.edit')->with('data', $data);
    }
