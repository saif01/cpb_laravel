...
class VisionController extends Controller
{
    ...
    public function All()
    {
        $allData = Vision::orderBy('id', 'desc')->get();
        return view('admin.about.vision.all')->with('allData', $allData);
    }
    ...
    public function Insert(Request $request)
    {
        ...
        if (!empty($image)) {
            ...
            $upload_path = 'public/images/vision/';
        ...
        if ($successData) {
            ...
            return Redirect()->route('vision.all')->with($notification);
        } else {
            $notification = array(
    ...
    public function editFormShow($id)
    {
        ...
        // print_r($data);
        return view('admin.about.vision.edit')->with('data', $data);
    }
