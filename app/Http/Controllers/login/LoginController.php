    ...
    public function loginAction(Request $request)
    {
        ...
        if ($data) {
            ...
            if ($status == 1) {
                ...
                Session::put('super', $data->super);
                Session::put('publish', $data->publish);
                Session::put('delete_data', $data->delete_data);
                Session::put('recruit', $data->recruit);
                Session::put('about', $data->about);
                Session::put('news', $data->news);
                Session::put('csr', $data->csr);
