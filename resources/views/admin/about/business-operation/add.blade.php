            ...
            <div class="col-md-12">
                <div class="card">
                    <div class="card-header">
                        <h4 class="card-title" id="bordered-layout-colored-controls">Business Operation Add</h4>
                    </div>
                    <div class="card-body">

                        <form action="{{ route('business-operation.insert') }}" method="post" >
                            @csrf
                             ...
                             <div class="row">
                                <div class="col-md-12">
                                    <div class="form-group">
                                        <label >Title</label>
                                        <input type="text" class="form-control" placeholder="Enter Business Operation Title" name="title" required="required" />
                                    </div>
                                </div>
                            </div>
