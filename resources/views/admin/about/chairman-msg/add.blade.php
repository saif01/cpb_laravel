            ...
            <div class="col-md-12">
                <div class="card">
                    <div class="card-header">
                        <h4 class="card-title" id="bordered-layout-colored-controls">Chairman Message Add</h4>

                    </div>
                    <div class="card-body">

                        <form action="{{ route('chairman.msg.insert') }}" method="post" enctype="multipart/form-data">
                            @csrf
