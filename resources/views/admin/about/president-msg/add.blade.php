            ...
            <div class="col-md-12">
                <div class="card">
                    <div class="card-header">
                        <h4 class="card-title" id="bordered-layout-colored-controls">President Message Add</h4>

                    </div>
                    <div class="card-body">

                        <form action="{{ route('president.msg.insert') }}" method="post" enctype="multipart/form-data">
                            @csrf
                            ...
                            <div class="row">
                                <div class="col-md-6">
                                    <div class="form-group">
                                        <label >Name</label>
                                        <input type="text" class="form-control" placeholder="Enter Title" name="name" required="required" />
                                    </div>
                                </div>
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-5">
                                        <img id="preview1" alt="Image Not Selected" class="rounded mx-auto d-block" style="margin-top: 30px; max-width:350px; max-height:200px;"/>
                                </div>
