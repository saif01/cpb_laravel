            ...
            <div class="col-md-12">
                <div class="card">
                    <div class="card-header">
                        <h4 class="card-title" id="bordered-layout-colored-controls">President Message Edit</h4>

                    </div>
                    <div class="card-body">

                        <form action="{{ route('president.msg.update', $data->id) }}" method="post" enctype="multipart/form-data">
                            @csrf
