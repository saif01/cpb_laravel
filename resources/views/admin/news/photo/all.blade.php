        ...
        <div class="col-12">
            <div class="card">
                <div class="card-header">
                    <h4 class="card-title">All Gallery Photos
                        <a href="{{ route('photo.add') }}">
                    ...
                    <div class="card-body card-dashboard table-responsive">
                        <table class="table table-striped table-bordered alt-pagination">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    <td>
                                         <img src="{{ asset($row->image) }}" alt="Image" height="100" width="200">
                                    </td>


                                    <td class="text-center">
                                        @if (Session::get('delete_data')==1)
                                        <a href="{{ route('photo.delete', $row->id)  }}" id="delete" class="btn gradient-ibiza-sunset white" title="Delete"> <i class="fa fa-trash"></i>: Delete</a>
                                        @endif
                                    </td>
                                </tr>
                                @endforeach
