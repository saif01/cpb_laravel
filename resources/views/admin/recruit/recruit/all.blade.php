        ...
        <div class="col-12">
            <div class="card">
                <div class="card-header">
                    <h4 class="card-title">All Recruitment Application
                        <a href="{{ route('recruit.add') }}">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    @if ((Session::get('super') == '1') || (Session::get('publish') == '1'))
                                        <!-- Make Status 0 -->
                                         @if($row->status == 1)
                                        <a href="{{ url('publish/'.$row->id.'/recruits'.'/status'.'/0') }}" id="draft" class="btn gradient-green-tea white"><i class="fa fa-toggle-on fa-lg "></i> : Active</a>

                                        <!-- Make Status 1     -->
                                        @else
                                        <a href="{{ url('publish/'.$row->id.'/recruits'.'/status'.'/1') }}" id="publish" class="btn gradient-bloody-mary white"><i class="fa fa-toggle-off fa-lg"></i> : Deactive</a>
                                        @endif
                                    @endif
                                        ...
                                        <div class="dropdown-divider"></div>
                                        <a href="{{ route('recruit.edit', $row->id) }}" title="Edit" class="editByModal btn gradient-purple-bliss white"><i class="fa fa-edit"></i>: Edit</a>
                                    </td>
                                </tr>
                                @endforeach
