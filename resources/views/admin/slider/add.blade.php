        ...
        <div class="col-md-12">
            <div class="card">
                <div class="card-header">
                    <h4 class="card-title" id="bordered-layout-colored-controls">Slider Add</h4>
                    ...
                    <form action="{{ route('slider.insert') }}" method="post" enctype="multipart/form-data" >
                        @csrf
                            <div class="row">
                                ...
                                <div class="row">
                                        <img id="preview1" alt="Image Not Selected" class="rounded mx-auto d-block" style="max-width:450px; max-height:300px;"/>
                                </div>
