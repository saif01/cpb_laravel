...
@section('content')
    ...
    <section class="page-title bg-overlay-black-60 parallax" data-jarallax='{"speed": 0.6}' style="background-image: url( {{ asset('app-assets/custom/img/header.jpg') }} ); padding-top: 13%; padding-bottom: inherit;">
      <div class="container">
        <div class="row">
          <div class="col-lg-12">
             <span class="directory">About CPB/Chairman Message/</span>
                  <div class="page-title-name">
                     <h1>C.P. Bangladesh Co., Ltd</h1>
                     <p>Message of Honorable Chairman</p>
                  </div>
          </div>
        </div>
      </div>
    ...
    <div class="row">
     <div class="col-lg-12 col-md-12">
         <div class="col-lg-2 col-md-2">
             <img class="picture" src="{{ asset($chairmanMsg->image) }}" alt="Image" >
         </div>

            <div class="col-lg-10 col-md-10" >
                <div class="ml-5 mt-40 first-letter">
                    <h3><b class="thm-color"> Name: </b> {{ $chairmanMsg->name }}</h3>
                    {!! $chairmanMsg->details !!}
                </div>
            </div>
    </div>
